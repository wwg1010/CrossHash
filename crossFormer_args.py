...
def parse_option():
    ...
    # parser.add_argument('--resume',default='crossformer-b.pth', help='resume from checkpoint')   #D:\wwg\Image\CrossHash-main\state_dict_mirflickr\0.6048340464262397_16_model.pth
    parser.add_argument('--resume',default='./model/crossformer-b.pth', help='resume from checkpoint')
